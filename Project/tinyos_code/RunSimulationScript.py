...
print "Activate debug message on queue operations"
t.addChannel("queue",out);

# creation of the network nodes

print "Creating PAN coordinator node...";
pan = t.getNode(1);
panTime = 0*t.ticksPerSecond(); #instant at which each node should be turned on
pan.bootAtTime(panTime);
print ">>>Will boot at time",  panTime/t.ticksPerSecond(), "[sec]";
